...
from mailings.views import MailingSettingsListView, MailingSettingsCreateView, MailingSettingsUpdateView, \
    ...
    ClientsCreateView, ClientsListView, LogListView, get_mailing_logs, IndexView, disable_mailing, enable_mailing, \
    MessagesCreateView, MessagesListView, MessagesUpdateView, MessagesDeleteView
...
urlpatterns = [
    ...
    path('create_message/', MessagesCreateView.as_view(), name='create_message'),
    path('edit/<int:pk>', MailingSettingsUpdateView.as_view(), name='edit'),
    path('edit_message/<int:pk>', MessagesUpdateView.as_view(), name='edit_message'),
    ...
    path('delete_message/<int:pk>', MessagesDeleteView.as_view(), name='delete_message'),
